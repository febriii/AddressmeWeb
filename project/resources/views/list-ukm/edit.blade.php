...
@section('content')
@include('users.partials.header', ['title' => __('Ubah Data Lokasi UKM')])
{{-- CEK STATUS LOGIN --}}
@php
    ...
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('list-ukm.update', $data->id)}}" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="pl-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_pemilik" class="custom-select" required="required">
                                    ...
                                    <option value="{{ $x->id }}" {{ ( $x->id == $getIdPemilik) ? 'selected' : '' }}> {{ $x->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <?php if($data->gambar_ukm != null){?>
                                <!-- <img src="/data/{{ $data->gambar_ukm }}" alt="" width="150"> -->
                            <div class="form-group">
